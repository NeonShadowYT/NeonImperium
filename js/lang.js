...
const translations = {
    ru: {
        ...
        licenseRefundText2: "Напишите в Telegram @NeonShindowsYT с подтверждением платежа (чек, скриншот).",
        licenseRefundText3: "Мы проверим, что платёж действительно поступил.",
        licenseRefundText4: "Вернём чистую сумму, которая дошла до нас (после вычета всех комиссий и налогов).",
        licenseRefundText5: "Срок — до 30 дней. Возврат возможен в течение 14 дней после покупки, если контент ещё не использован.",
        ...
        licenseSection9Title: "Разрешение споров",
        ...
        licenseTelegramTitle: "📢 Жалобы на противоправный контент",
        licenseTelegramContact: "Вы можете сообщить в Telegram: @NeonShindowsYT",
        licenseTelegramNote: "Ответ не гарантируется, сроков нет. Сообщение будет прочитано по возможности.",
        ...
        // НОВЫЕ КЛЮЧИ (добавлены по вашему запросу)
        ...
        licenseCommercialAllowed: "Продавать копии игры, включать в платные сборники, сдавать в аренду — коммерческое использование без отдельного разрешения.",
        ...
        licenseDisputeMars: "Шутка: все споры рассматриваются на планете Марс. Реальность: по законодательству РФ, суд по месту жительства ответчика.",
    ...
    en: {
        ...
        licenseRefundText2: "Write to Telegram @NeonShindowsYT with payment proof (receipt, screenshot).",
        licenseRefundText3: "We will verify that the payment was actually received.",
        licenseRefundText4: "We will refund the net amount that reached us (after all fees and taxes).",
        licenseRefundText5: "Deadline: up to 30 days. Refund possible within 14 days of purchase if content has not been used.",
        ...
        licenseSection9Title: "Dispute Resolution",
        ...
        licenseTelegramTitle: "📢 Complaints about illegal content",
        licenseTelegramContact: "You can report to Telegram: @NeonShindowsYT",
        licenseTelegramNote: "Response not guaranteed, no deadlines. Message will be read if possible.",
        ...
        licenseCommercialAllowed: "Sell copies of the game, include in paid compilations, rent out — commercial use without separate permission.",
        ...
        licenseDisputeMars: "Joke: all disputes are heard on Mars. Reality: under Russian law, court at respondent's place of residence.",
